                ...
                <div class="faq-area pt--75 pb--70">
                    <div class="container">
                        <div class="row mb--40">
                            <div class="col-12">
                                <h2>자주 하는 질문(FAQ)</h2>
                                <p>바이로컬을 찾는 분들이 자주 하시는 질문을 모았습니다. 이곳에서도 찾지 못한 문의사항은 QNA를 이용해 주십시오.</p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="row no-gutters justify-content-center">
                                    <div class="col-lg-8 col-10 text-center">
                                        <h3 class="mb--35">원하는 답변을 찾지 못하셨나요? QNA에 질문해 주세요.</h3>
                                        <a href="QNAform.do" class="btn btn-bg-white btn-hover-2">QNA에 질문하기<i class="la la-caret-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>

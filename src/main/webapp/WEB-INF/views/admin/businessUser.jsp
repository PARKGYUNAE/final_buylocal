...
<table class="menu" align="center">
			<tr>
				<td width="400" height="400" align="center">사업자 정보
					<div id="menu1">
						<c:url var="businessUserInfo" value="businessUserInfo.do"/>
						<a href="${ businessUserInfo }">
							<img id="menu2" src="resources/admin/images/businessInfo.png"
							width="250" height="250">
						</a>
					</div>
				</td>
				<td width="400" height="400" align="center">등급 관리
					<div id="menu2">
					<c:url var="businessUserGrade" value="businessUserGrade.do"/>
						<a href="${ businessUserGrade }">
							<img id="menu2" src="resources/admin/images/businessGrade.png"
							width="250" height="250">
						</a>
					</div>
				</td>

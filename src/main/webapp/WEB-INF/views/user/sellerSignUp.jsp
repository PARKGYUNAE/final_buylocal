                                    ...
                                    <div class="tab-pane fade show active" id="accountdetails">
                                        ...
                                        <table class="" width="40%" align="center" cellspacing="5">
                                            ...
                                            <tr>
                                                ...
                                                <td>    
                                                    <input type="password" name="userPwd" id="userPwd" class="form__input" placeholder="영대소문자/숫자 포함 8글자 이상">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>    
                                                    <input type="password" name="userPwd2" id="userPwd2" class="form__input" placeholder="">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>

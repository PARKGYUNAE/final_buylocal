...
<table class="menu" align="center">
			<tr>
				<td width="400" height="400" align="center">회원 정보
					<div id="menu1">
						<c:url var="normalUserInfo" value="normalUserInfo.do"/>
						<a href="${ normalUserInfo }">
							<img id="menu1" src="resources/admin/images/people.png"
							width="250" height="250">
						</a>
					</div>
				</td>
				<td width="400" height="400" align="center">구매 내역
					<div id="menu2">
						<c:url var="normalUserBuy" value="adNormalUserBuy.do"/>
						<a href="${normalUserBuy}">
							<img id="menu2" src="resources/admin/images/information.png"
							width="250" height="250">
						</a>
					</div>
				</td>

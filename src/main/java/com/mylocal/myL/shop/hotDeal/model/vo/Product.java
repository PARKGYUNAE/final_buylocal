...
public String toString() {
	return "Product [pNo=" + pNo + ", pName=" + pName + ", pThumb=" + pThumb + ", pOriginalPrice=" + pOriginalPrice
			...
			+ bShopAddress + ", cEmail=" + cEmail + ", cPhone=" + cPhone + ", pVolume=" + pVolume + ", pProductDate="
			+ pProductDate + ", pTreatment=" + pTreatment + ", bPIC=" + bPIC + ", pStarRate=" + pStarRate + ", pOrigin="
			+ pOrigin + ", pTitle=" + pTitle + ", pBoard=" + pBoard + ", pStartdate=" + pStartdate + ", pEndDate="
			+ pEndDate + "]";
}

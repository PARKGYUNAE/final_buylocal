...
<table class="menu" align="center">
			<tr>
				<td width="400" height="400" align="center">일반 회원
					<div id="menu1">
						<c:url var="normalUserInfo" value="normalUser.do"/>
						<a href="${ normalUser }">
				...
				<td width="400" height="400" align="center">사업자 회원
					<div id="menu2">
						<c:url var="normalUserBuy" value="businessUser.do"/>
						<a href="${businessUser}">
